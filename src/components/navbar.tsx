        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex items-center justify-between h-full">
            <Link href="/" className="flex items-center gap-2.5 shrink-0">
              <img src="/logo.png" alt="Mc Quest" className="h-10 w-auto" width={40} height={40} />
              <span className="text-sm font-bold font-[family-name:var(--font-heading)] text-ivory tracking-wide xl:hidden">
                McQuest
              </span>
            </Link>
